...
@Component({
  selector: 'app-store-widjet',
  templateUrl: './store-widjet.component.html',
  styleUrls: ['./store-widjet.component.css']
})
export class StoreWidjetComponent implements OnInit {
