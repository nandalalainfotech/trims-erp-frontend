...
@Component({
  selector: 'app-purchase-widjet',
  templateUrl: './purchase-widjet.component.html',
  styleUrls: ['./purchase-widjet.component.css']
})
export class PurchaseWidjetComponent implements OnInit {
