...
@Component({
  selector: 'app-production-widjet',
  templateUrl: './production-widjet.component.html',
  styleUrls: ['./production-widjet.component.css']
})
export class ProductionWidjetComponent implements OnInit {
