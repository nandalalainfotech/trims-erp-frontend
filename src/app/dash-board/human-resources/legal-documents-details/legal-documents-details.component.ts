...
@Component({
  selector: 'app-legal-documents-details',
  templateUrl: './legal-documents-details.component.html',
  styleUrls: ['./legal-documents-details.component.css']
})
export class LegalDocumentsDetailsComponent implements OnInit {
