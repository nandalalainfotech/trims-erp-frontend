...
@Component({
  selector: 'app-manufacture-setting',
  templateUrl: './manufacture-setting.component.html',
  styleUrls: ['./manufacture-setting.component.css']
})
export class ManufactureSettingComponent implements OnInit {
