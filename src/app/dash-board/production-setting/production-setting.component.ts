...
@Component({
  selector: 'app-production-setting',
  templateUrl: './production-setting.component.html',
  styleUrls: ['./production-setting.component.css']
})
export class ProductionSettingComponent implements OnInit {
