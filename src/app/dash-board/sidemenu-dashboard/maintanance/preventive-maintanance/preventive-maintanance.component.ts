...
@Component({
  selector: 'app-preventive-maintanance',
  templateUrl: './preventive-maintanance.component.html',
  styleUrls: ['./preventive-maintanance.component.css']
})
export class PreventiveMaintananceComponent implements OnInit {
