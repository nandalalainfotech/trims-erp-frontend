...
@Component({
  selector: 'app-searched-popup',
  templateUrl: './searched-popup.component.html',
  styleUrls: ['./searched-popup.component.css']
})
export class SearchedPopupComponent implements OnInit {
